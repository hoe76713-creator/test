        ...
        # =========================================================
            ...
            if "법정직무조회7" in utterance:
                ...
                if root is not None:
                    ...
                    cards = []
                    for i in range(0, len(display), 3):
                        btns = [{"action": "message", "label": f"{(it.findtext('installationPlace') or '-').strip()}({it.findtext('elevatorNo')})", "messageText": f"{it.findtext('elevatorNo')} 법정직무조회7 결과"} for it in display[i:i+3]]
            ...
            if "법정직무조회8" in utterance:
                ...
                if root is not None:
                    ...
                    for i in range(0, len(display), 3):
                        ...
                        btns = [{"action": "message","label": f"{(it.findtext('installationPlace') or '-').strip()}({it.findtext('elevatorNo')})","messageText": f"{it.findtext('elevatorNo')} 법정직무조회8 결과"} for it in sub_items]
