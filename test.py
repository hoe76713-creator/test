    ...
    try:
        ...
        if len(elv_no) == 7:
            ...
            if "언제까지선임해야하나요" in utterance:
                return kakao_res([{"simpleText": {"text": "📅 [선임 기한 안내]\n\n승강기 관리주체는 사유 발생일로부터 3개월 이내에 안전관리자를 선임해야 합니다.\n(해임 시에도 동일하게 3개월 이내 재선임 필수)"}}])
            
            if "교육은언제까지받나요" in utterance:
                return kakao_res([{"simpleText": {"text": "🎓 [교육 이수 기준]\n\n안전관리자는 선임 후 3개월 이내에 승강기 관리교육을 받아야 하며, 이후 3년마다 재교육(보수교육)을 이수해야 합니다."}}])
